...
class SetPasswordScreen extends StatefulWidget {
  ...
  const SetPasswordScreen(this.email, this.otp,  {super.key});

  @override
  BaseState<SetPasswordScreen> createState() => _SetPasswordScreenState();
}

class _SetPasswordScreenState extends BaseState<SetPasswordScreen> {
  ...
  void initState(){
    ...
    email = (widget as SetPasswordScreen).email;
    otp = (widget as SetPasswordScreen).otp;
    super.initState();
  }
